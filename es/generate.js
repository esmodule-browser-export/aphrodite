import createPrefixer from 'inline-style-prefixer-esmodule-browser-export/es/createPrefixer';


import calc from 'inline-style-prefixer-esmodule-browser-export/es/plugins/calc'
import crossFade from 'inline-style-prefixer-esmodule-browser-export/es/plugins/crossFade'
import cursor from 'inline-style-prefixer-esmodule-browser-export/es/plugins/cursor'
import filter from 'inline-style-prefixer-esmodule-browser-export/es/plugins/filter'
import flex from 'inline-style-prefixer-esmodule-browser-export/es/plugins/flex'
import flexboxIE from 'inline-style-prefixer-esmodule-browser-export/es/plugins/flexboxIE'
import flexboxOld from 'inline-style-prefixer-esmodule-browser-export/es/plugins/flexboxOld'
import gradient from 'inline-style-prefixer-esmodule-browser-export/es/plugins/gradient'
import imageSet from 'inline-style-prefixer-esmodule-browser-export/es/plugins/imageSet'
import position from 'inline-style-prefixer-esmodule-browser-export/es/plugins/position'
import sizing from 'inline-style-prefixer-esmodule-browser-export/es/plugins/sizing'
import transition from 'inline-style-prefixer-esmodule-browser-export/es/plugins/transition'
var w = ["Webkit"];
var m = ["Moz"];
var ms = ["ms"];
var wm = ["Webkit","Moz"];
